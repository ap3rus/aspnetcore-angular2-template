...
namespace WebApp.Prerendering
{
    ...
    public static class Prerenderer
    {
        ...
        static Prerenderer()
        {
            ...
            {
                var script = EmbeddedResourceReader.Read(typeof(Microsoft.AspNetCore.SpaServices.Prerendering.Prerenderer), "/Content/Node/prerenderer.js");
